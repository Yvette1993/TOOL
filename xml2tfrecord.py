...
def _process_image(directory, name):
    ...
    image_data = tf.io.gfile.GFile(filename, 'rb').read()  #使用gfile读取图片
...
def _convert_to_example(image_data, labels, labels_text, bboxes, shape, difficult, truncated):
    ...
    example = tf.train.Example(features=tf.train.Features(feature={
        ...
        'label_text': bytes_feature(labels_text),
...
if __name__ == '__main__':
    ...
    voc_root = '/media/lisali/7d00416d-8275-4263-979a-70ae47372950/VOC/VOCdevkit/'
